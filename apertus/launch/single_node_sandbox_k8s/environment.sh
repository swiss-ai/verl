...
export TOKENIZER_NAME_OR_PATH="/capstor/store/cscs/swissai/infra01/reasoning/models/tokenizers/apertus_emu3.5_wavtok_text_only"

export TRAINING_DATA_DIR="/capstor/store/cscs/swissai/infra01/reasoning/apertus_megatron/data_think"
