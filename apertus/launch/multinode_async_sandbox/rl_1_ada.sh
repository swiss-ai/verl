...
WORKING_DIR="/iopsstor/scratch/cscs/msantelmo/SSFT/verl_rl"
HOME="${SCRATCH_HOME}"
...
EXPORT_VARS=(
  ...
  "ADAPTIVE_GROUP_SIZE=${ADAPTIVE_GROUP_SIZE}"
  "ADAPTIVE_MAX_NUM_ROUNDS=${ADAPTIVE_MAX_NUM_ROUNDS}"
  "ADAPTIVE_SPECULATIVE_PROMPT_CONCURRENCY=${ADAPTIVE_SPECULATIVE_PROMPT_CONCURRENCY}"
  "ADAPTIVE_TARGET_INFLIGHT_TRAJECTORIES_PER_REPLICA=${ADAPTIVE_TARGET_INFLIGHT_TRAJECTORIES_PER_REPLICA}"
)
